...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-16">
      ...
      <p className="mt-4 text-gray-100">By using Lifebook.AI you agree to these terms.</p>
      ...
      <ul className="mt-4 list-disc space-y-2 pl-6 text-gray-100 marker:text-sky-400">
        <li>Upload only content you have rights to use.</li>
        <li>No harmful, unlawful, or abusive activity.</li>
        <li>Service is provided “as-is”; features may change.</li>
      </ul>

      <h2 className="mt-10 text-xl font-medium text-white">Accounts & email</h2>
      <p className="mt-4 text-gray-100">
        You agree to receive essential emails (e.g., waitlist updates). You can unsubscribe from
