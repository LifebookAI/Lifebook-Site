    ...
    <main className="max-w-3xl mx-auto px-4 py-12 space-y-8">
      <header className="space-y-2">
        ...
        <p className="text-sm text-neutral-400">
          A simple place to keep the notes, runbooks, and artifacts you create while working through
          Lifebook workflows and Study Tracks.
        </p>
      </header>

      <section className="space-y-3 text-sm text-neutral-300">
        <p>
          For the MVP, your Library is wherever you already keep your work: Notion, Obsidian, OneNote,
          a private repo, or simple markdown files.
        </p>
        <p>
